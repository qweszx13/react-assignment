...
export default function HomeHeader(){
  ...
  // event type 何を指定するんだ
  const handleChangeOrg = (e) => setOrgValue(e.target.value);

  const handleChangeRepo = (e) => setRepoValue(e.target.value);

  const handleChangePageNumber = (e) => setIssuePageNumber(nanIsOne(e.target.value));
